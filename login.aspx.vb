...
Partial Class login
    ...
    Protected Sub btnLogin_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnLogin.Click
        ...
        sqlUserName += "LEFT JOIN WEBSaleMenu ON SYSTEMNAME.SCODE = WEBSaleMenu.SYSNAME "
        sqlUserName += "LEFT Join WEBSalePermis ON WEBSaleMenu.MID = WEBSalePermis.MenuID "
        sqlUserName += "LEFT JOIN USERS ON WEBSalePermis.UID = USERS.UserID "
        sqlUserName += "WHERE SYSTEMNAME.SCODE = 'TYNS' "
